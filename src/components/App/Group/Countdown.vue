<template>
    <div class="basis-32 border-orange-300 border-2 bg-white/80 rounded-xl relative">
        <div class="w-full bg-orange-300/40 absolute bottom-0" :style="{height: `${daysLeft}%`}"/>
